...
namespace Scheduleless.Helpers
{
	...
	{
		public static IsStringEmptyConverter Instance = new IsStringEmptyConverter();
	...
	public class IsInverseStringEmptyConverter : IValueConverter
	{
		public static IsInverseStringEmptyConverter Instance = new IsInverseStringEmptyConverter();
